...
class Constants
{
    ...
    public static var bumperMaterial(default, null) = new Material(100, 0.001, 0.005, 1);
}
...
class TileType
{
    ...
    public static inline var LEFT_FLIPPER = 11;
    public static inline var RIGHT_FLIPPER = 12;
